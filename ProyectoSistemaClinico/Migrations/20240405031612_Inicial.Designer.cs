...
namespace ProyectoSistemaClinico.Migrations
{
    ...
    [Migration("20240405031612_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoSistemaClinico.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProyectoSistemaClinico.Models.Citas", b =>
                {
            ...
            modelBuilder.Entity("ProyectoSistemaClinico.Models.Doctor", b =>
                {
                    ...
                    b.Property<string>("EspecialidadMedica")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ProyectoSistemaClinico.Models.HistorialClinico", b =>
                {
                    ...
                    b.Property<string>("HistorialEnfermedadesCirugias")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NotasProgresoSeguimiento")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReaccionesAlergias")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ResultadosPruebasMedicas")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ProyectoSistemaClinico.Models.HistorialClinicoDetalle", b =>
                {
                    ...
                    b.Property<string>("EjercicioFisico")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProyectoSistemaClinico.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProyectoSistemaClinico.Models.HistorialClinico", b =>
                {
                    b.Navigation("HistorialClinicoDetalle");
                });
